...
#include "../../../share/vm/prims/AllocationTracingDefinitions.hpp"
#include "../../../share/vm/prims/AllocationSites.hpp"
#include "../../../share/vm/prims/EventsRuntime.hpp"
#include "../../../share/vm/prims/EventsInterpreterRuntime.hpp"
    ...
    case BarrierSet::G1SATBCTLogging:
      {
        ...
        if (val == noreg) {
          ...
          if(TraceObjectsPointers || KillNullOptimization) {
              __ xorq(rbx, rbx); // rbx = 0
...
void TemplateTable::_new() {
  ...
  if (UseTLAB || Universe::heap()->supports_inline_contig_alloc()) {
    ...
    if(TraceObjectsAllocations) {
      SkipIfEqual* skip = TraceObjectsToggleAtRunTime ? new SkipIfEqual(_masm, &TraceObjects, false) : NULL;
      __ get_method(rbx);
      __ movptr(rcx, r13);
      call_VM(rax, CAST_FROM_FN_PTR(address, TraceObjectsUseNakedSlowPaths ? EventsInterpreterRuntime::fire_obj_alloc_no_arrays_naked : EventsInterpreterRuntime::fire_obj_alloc_no_arrays), rax, rbx, rcx);
      delete skip;
    }
