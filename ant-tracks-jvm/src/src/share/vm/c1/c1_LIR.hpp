...
class LIR_OpAllocObj : public LIR_Op1 {
 ...
 public:
  LIR_OpAllocObj(LIR_Opr klass, LIR_Opr result,
                 ...
                 int hdr_size, int obj_size, bool init_check, CodeStub* stub, CodeStub* trace_stub, Klass* type)
  ...
  CodeStub* stub()       const                   { return _stub;        }
  CodeStub* trace_stub() const                   { return _trace_stub;  }
  Klass* allocated_type() const                   { return _type;  }
...
class LIR_OpAllocArray : public LIR_Op {
 ...
 private:
  ...
  CodeStub* _stub;
  CodeStub* _trace_stub;
  Klass* _allocated_type;

 public:
  LIR_OpAllocArray(LIR_Opr klass, LIR_Opr len, LIR_Opr result, LIR_Opr t1, LIR_Opr t2, LIR_Opr t3, LIR_Opr t4, BasicType type, CodeStub* stub, CodeStub* trace_stub, Klass* allocated_type)
  ...
  CodeStub* stub()    const                      { return _stub;        }
  CodeStub* trace_stub() const                   { return _trace_stub;  }
  Klass* allocated_type() const                  { return _allocated_type; }
...
class LIR_List: public CompilationResourceObj {
 ...
 public:
  ...
  void allocate_object(LIR_Opr dst, LIR_Opr t1, LIR_Opr t2, LIR_Opr t3, LIR_Opr t4, int header_size, int object_size, LIR_Opr klass, bool init_check, CodeStub* stub, CodeStub* trace_stub, Klass* klass_type);
  void allocate_array(LIR_Opr dst, LIR_Opr len, LIR_Opr t1,LIR_Opr t2, LIR_Opr t3,LIR_Opr t4, BasicType type, LIR_Opr klass, CodeStub* stub, CodeStub* trace_stub, Klass* klass_type);
