...
void LIRGenerator::new_instance(LIR_Opr dst, ciInstanceKlass* klass, bool is_unresolved, LIR_Opr scratch1, LIR_Opr scratch2, LIR_Opr scratch3, LIR_Opr scratch4, LIR_Opr klass_reg, CodeEmitInfo* info) {
  ...
  if (UseFastNewInstance && klass->is_loaded()
    ...
    CodeStub* trace_slow_path = TraceObjectsAllocations && TraceObjectsC1RelocateSlowPath ? new FireAllocFastStub(info, (Klass*) klass->constant_encoding()) : NULL;
    ...
    __ allocate_object(dst, scratch1, scratch2, scratch3, scratch4,
                       oopDesc::header_size(), instance_size, klass_reg, !klass->is_initialized(), slow_path, trace_slow_path, (Klass*) klass->constant_encoding());
  } else {
