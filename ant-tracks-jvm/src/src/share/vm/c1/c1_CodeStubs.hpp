...
class FireAllocFastStub: public CodeStub {
  private:
    CodeEmitInfo* _info;
    Klass* _klass;
  public:
    FireAllocFastStub(CodeEmitInfo* info, Klass* klass);
    virtual void emit_code(LIR_Assembler* e);
    virtual void visit(LIR_OpVisitState* visitor) {
      visitor->do_slow_case(_info);
    }
...
class NewTypeArrayStub: public CodeStub {
 ...
 public:
  NewTypeArrayStub(LIR_Opr klass_reg, LIR_Opr length, LIR_Opr result, CodeEmitInfo* info, Klass* klass);
  virtual void emit_code(LIR_Assembler* e);
  virtual CodeEmitInfo* info() const             { return _info; }
  virtual void visit(LIR_OpVisitState* visitor) {
    visitor->do_slow_case(_info);
...
class NewObjectArrayStub: public CodeStub {
 ...
 public:
  NewObjectArrayStub(LIR_Opr klass_reg, LIR_Opr length, LIR_Opr result, CodeEmitInfo* info, Klass* klass);
  virtual void emit_code(LIR_Assembler* e);
  virtual CodeEmitInfo* info() const             { return _info; }
  virtual void visit(LIR_OpVisitState* visitor) {
    visitor->do_slow_case(_info);
