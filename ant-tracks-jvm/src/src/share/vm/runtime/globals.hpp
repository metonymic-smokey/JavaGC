...
#define RUNTIME_FLAGS(develop, develop_pd, product, product_pd, diagnostic, experimental, notproduct, manageable, product_rw, lp64_product) \
  ...
  experimental(intx, SurvivorAlignmentInBytes, 0,                           \
           "Default survivor space alignment in bytes")                     \
                                                                            \
  product(bool, TraceObjects, false,                                        \
         "Enable tracing of objects")                                       \
                                                                            \
  product(bool, TraceObjectsPointers, false,                                \
         "Enable tracing of pointers")                                      \
                                                                            \
  product(bool, TraceObjectsPointersDirtyOnly, false,                       \
         "Enables tracing of dirty pointers only")                          \
                                                                            \
  product(bool, TraceObjectsGCRoots, false,                                 \
        "Enable tracing of root pointers")                                  \
                                                                            \
  product(bool, TraceObjectsClassDefinitions, true,                         \
         "Enable storing class definitions when tracing objects")           \
                                                                            \
  product(bool, ReuseUnloadedAllocationSites, true,                         \
         "Enables reusing of unloaded allocation site identifiers")         \
                                                                            \
  product(bool, ExtendAllocationSiteIdRange, true,                          \
         "Extends range of allocation site identifiers")                    \
                                                                            \
  product(bool, KillNullOptimization, false,                                \
         "Disables CardTable-Nullpointer-optimization")                     \
                                                                            \
  product(uintx, TraceObjectsBufferSize, 16*K,                              \
         "Event buffer size")                                               \
                                                                            \
  product(bool, TraceObjectsFuzzyBufferSizes, true,                         \
         "Whether to vary the buffer sizes")                                \
                                                                            \
  product(double, TraceObjectsFuzzyBufferSizeMaxDeviation, 0.50,            \
         "How much to vary the buffer size")                                \
                                                                            \
  product(ccstr, TraceObjectsTraceFile, "./trace",                          \
         "File to write the trace to")                                      \
                                                                            \
  product(ccstr, TraceObjectsSymbolsFile, "./symbols",                      \
         "File to write symbols to")                                        \
                                                                            \
  product(ccstr, TraceObjectsClassDefinitionsFile, "./class_definitions",   \
         "File to write class definitions to")                              \
                                                                            \
  product(bool, TraceObjectsCompressTrace, false,                           \
         "Whether to compress the event stream on the fly")                 \
                                                                            \
  product(intx, TraceObjectsCompressionThreads, 0,                          \
         "Number of compression threads to be started, <= 0 dynamic")       \
                                                                            \
  product(bool, TraceObjectsCompressTraceUseLZW, false,                     \
         "Whether to compress the event stream on the fly")                 \
                                                                            \
  product(uintx, TraceObjectsCompressTraceLZWIndexCollection, 0,            \
         "The internal collection strategy to use for LZW compression")     \
                                                                            \
  product(bool, TraceObjectsCompressTraceUseLZWQuyteTree, false,            \
         "Whether to compress the event stream on the fly")                 \
                                                                            \
  product(bool, TraceObjectsCompressTraceAdaptively, false,                 \
         "Whether to compress the event stream on the fly adaptively")      \
                                                                            \
  product(double, TraceObjectsCompressTraceAdaptiveThreshold, 0.50,         \
         "At which flush queue fill level compression is not used anymore") \
                                                                            \
  product(bool, TraceObjectsEagerFlush, false,                              \
         "Whether to flush eagerly into the file")                          \
                                                                            \
  diagnostic(intx, TraceObjectsSelfMonitoring, 0,                           \
         "Whether to monitor performance metrics (exposed via JVMTI) (0 = off, 1 = global metrics (no performance overhead), 2 = event metrics (performance overhead))") \
                                                                            \
  diagnostic(bool, TraceObjectsSelfMonitoringDumpOnExit, false,             \
         "Whether to dump statistics on VM exit")                           \
                                                                            \
  product(intx, TraceObjectsMaxFlushBacklog, 256,                           \
         "Maximum number of buffers to flush stored before threads are halted") \
                                                                            \
  product(intx, TraceObjectsMaxFreeBuffers, 1024,                           \
         "Maximum number of free buffers kept for fast replacement")        \
                                                                            \
  lp64_product(bool, TraceObjectsC1UseThreadRegister, true,                 \
         "Whether to use the r15_thread register for accessing the thread") \
                                                                            \
  lp64_product(bool, TraceObjectsC1RelocateSlowPath, true,                  \
         "Whether to move the slow path somewhere else in the method to save one jump in the fast path") \
                                                                            \
  develop(bool, TraceObjectsC1AlwaysSlowPath, false,                        \
         "Whether to always use the slow path")                             \
                                                                            \
  develop(bool, TraceObjectsC1Breakpoint, false,                            \
         "Whether to automatically insert a breakpoint in C1 event code")   \
                                                                            \
  product(bool, TraceObjectsC1ClearRegisters, false,                        \
         "Clear temporary registers in C1")                                 \
                                                                            \
  experimental(bool, TraceObjectsC1ExperimentalEnableFastTLABRefill, false, \
         "Enable fast TLAB refill in C1")                                   \
                                                                            \
  develop(bool, TraceObjectsInsertAnchors, false,                           \
         "Insert Magic Byte Sequences at certain positions in the event trace") \
                                                                            \
  develop(intx, TraceObjectsGCMoveRegionALot, 0,                            \
         "Max region size for gc moves (0 ... no limit)")                   \
                                                                            \
  develop(bool, TraceObjectsGCEnableParanoidAssertions, false,              \
         "Enables paranoid and expensive assertions on consistency of GC events") \
                                                                            \
  product(bool, TraceObjectsAsyncIO, true,                                  \
         "Whether to dispatch IO into dedicated worker threads")            \
                                                                            \
  product(intx, TraceObjectsParallelWorkerThreads, 1,                       \
         "How many worker threads should be used if async IO is enabled")   \
                                                                            \
  product(bool, TraceObjectsUseNakedSlowPaths, false,                       \
         "Whether slow path calls should do a proper thread transition (including a safepoint)") \
                                                                            \
  product(uint64_t, TraceObjectsMaxTraceSize, 0,                            \
         "When to restart the trace file (approximately)")                  \
                                                                            \
  product(double, TraceObjectsTraceSizeMaxDeviation, 0.1,                   \
         "When to force a major GC to restart the trace")                   \
                                                                            \
  product(bool, TraceObjectsMaxTraceSizeSynchronizeOnMinor, true,           \
         "Howto synchronize when max trace size is exceeded")               \
                                                                            \
  product(intx, TraceObjectsMaxTraceFileCount, 0,                           \
         "How many trace files to keep")                                    \
                                                                            \
  product(bool, TraceObjectsSaveAllocationSitesForSyncs, true,              \
         "Whether to store the allocation site in objects")                 \
                                                                            \
  diagnostic(bool, TraceObjectsJustSaveAllocationSites, false,              \
         "Whether to store the allocation site in objects (for performance tests only)") \
                                                                            \
  product(bool, TraceObjectsHashCodeElimination, true,                      \
         "Whether to eliminate hash code generation if custom hashCode function is present") \
                                                                            \
  product(bool, TraceObjectsC1SaveAllocationSitesAlwaysSlowPath, false,     \
         "Whether to generate a fast path at every allocation")             \
                                                                            \
  product(bool, TraceObjectsC1SaveAllocationSitesShareGeneratedCode, false, \
         "Whether to generate a fast path at every allocation")             \
                                                                            \
  develop(bool, TraceObjectsC1SaveAllocationSitesBreakpoint, false,         \
         "Whether to automatically insert a breakpoint before storing")     \
                                                                            \
  develop(bool, TraceObjectsC2Breakpoint, false,                            \
         "Whether to automatically insert a breakpoint in C2 event code")   \
                                                                            \
  develop(bool, TraceObjectsC2SaveAllocationSitesBreakpoint, false,         \
         "Whether to automatically insert a breakpoint in C2 allocation site storage code")   \
                                                                            \
  diagnostic(bool, TraceObjectsSelfMonitoringCutTraceOnReset, false,        \
         "Whether to forcefully cut the trace when properties are reset")   \
                                                                            \
  develop(bool, TraceObjectsC2AlwaysSlowPath, false,                        \
         "Whether to always use the slow path")                             \
                                                                            \
  develop(bool, TraceObjectsC2SaveAllocationSitesAlwaysSlowPath, false,     \
         "Whether to always use the slow path")                             \
                                                                            \
  product(bool, TraceObjectsC2ZeroObjectsBeforeSlowPathCall, false,         \
         "Whether to zero objects before or within the slow path")          \
                                                                            \
  product(bool, TraceObjectsThreadEvents, true,                             \
          "Enable thread events")                                           \
                                                                            \
  product(uintx, TraceObjectsMaxStackTraceDepth, 64,                        \
          "Maximal size for stack traces")                                  \
                                                                            \
  product(uintx, TraceObjectsStackTraceRecursionDetectionDepth, 16,         \
          "Detection depth for recursions")                                 \
                                                                            \
  product(bool, TraceObjectsC2FastDeviantTypeEvent, true,                   \
          "Enable fast events for allocation sites with unknown type")      \
                                                                            \
  diagnostic(bool, TraceObjectsCheckAllocationSitesOnExit, false,           \
          "Whether to check allocation sites for consistency on VM exit")   \
                                                                            \
  product(bool, TraceObjectsAllocationStackTraces, true,                    \
          "Whether to capture stack traces at allocations")                 \
                                                                            \
  product(intx, TraceObjectsAllocationStackTraceFrequency, 8*K,             \
          "Frequency for capturing stack traces at allocations")            \
                                                                            \
  experimental(bool, TraceObjectsToggleAtRunTime, false,                    \
          "Whether object tracing can be switched on and off at run time")  \
                                                                            \
  product(bool, PrintTraceObjects, false,                                   \
          "Log Object Tracing")                                             \
                                                                            \
  product(bool, PrintTraceObjectsSymbols, false,                            \
          "Log Object Tracing")                                             \
                                                                            \
  product(bool, PrintTraceObjectsMajorEvents, false,                        \
          "Log Object Tracing")                                             \
                                                                            \
  product(bool, PrintTraceObjectsHumongous, false,                          \
          "Log Humongous Allocations")                                      \
                                                                            \
  product(bool, TraceObjectsSaveAllocationSiteAllowUnknown, true,           \
          "Allow unknown allocation sites")                                 \
                                                                            \
