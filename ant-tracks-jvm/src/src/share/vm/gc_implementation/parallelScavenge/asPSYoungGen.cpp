...
void ASPSYoungGen::resize_spaces(size_t requested_eden_size,
  ...
  if(TraceObjects) postpone_space_events {
    EventsGCRuntime::schedule_space_redefine(PARALLEL_GC_EDEN_ID, eden_space()->bottom(), eden_space()->end());
    EventsGCRuntime::schedule_space_redefine(PARALLEL_GC_SURVIVOR_1_ID, survivor_1_space()->bottom(), survivor_1_space()->end());
    EventsGCRuntime::schedule_space_redefine(PARALLEL_GC_SURVIVOR_2_ID, survivor_2_space()->bottom(), survivor_2_space()->end());
  }
}
