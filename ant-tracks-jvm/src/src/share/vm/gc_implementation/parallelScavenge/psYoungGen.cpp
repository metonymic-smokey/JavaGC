...
void PSYoungGen::set_space_boundaries(size_t eden_size, size_t survivor_size) {
  ...
  if(TraceObjects) {
    EventsRuntime::fire_space_creation(PARALLEL_GC_EDEN_ID, eden_space()->bottom(), eden_space()->end());    
    EventsRuntime::fire_space_creation(PARALLEL_GC_SURVIVOR_1_ID, survivor_1_space()->bottom(), survivor_1_space()->end());
    EventsRuntime::fire_space_creation(PARALLEL_GC_SURVIVOR_2_ID, survivor_2_space()->bottom(), survivor_2_space()->end());
...
void PSYoungGen::mangle_survivors(MutableSpace* s1,
                                  ...
                                  MutableSpace* s2,
                                  MemRegion s2MR) {
  SpaceRedefinition redefinition_survivor_1(PARALLEL_GC_SURVIVOR_1_ID, survivor_1_space());
  SpaceRedefinition redefinition_survivor_2(PARALLEL_GC_SURVIVOR_2_ID, survivor_2_space());
...
void PSYoungGen::resize_spaces(size_t requested_eden_size,
  ...
  SpaceRedefinition redefinition_eden(PARALLEL_GC_EDEN_ID, eden_space());
  SpaceRedefinition redefinition_survivor_1(PARALLEL_GC_SURVIVOR_1_ID, survivor_1_space());
  SpaceRedefinition redefinition_survivor_2(PARALLEL_GC_SURVIVOR_2_ID, survivor_2_space());
...
void PSYoungGen::reset_survivors_after_shrink() {
  ...
  SpaceRedefinition redefinition_survivor(space_shrinking == survivor_1_space() ? PARALLEL_GC_SURVIVOR_1_ID : PARALLEL_GC_SURVIVOR_2_ID, space_shrinking);
