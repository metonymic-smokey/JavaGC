...
HeapRegion* MutatorAllocRegion::allocate_new_region(size_t word_size,
                                                    bool force) {
  HeapRegion* res = _g1h->new_mutator_alloc_region(word_size, force);
  return res;
}
...
HeapRegion* SurvivorGCAllocRegion::allocate_new_region(size_t word_size,
  ...
  HeapRegion* res = _g1h->new_gc_alloc_region(word_size, count(), InCSetState::Young);
  return res;
}
...
HeapRegion* OldGCAllocRegion::allocate_new_region(size_t word_size,
                                                  bool force) {
  assert(!force, "not supported for GC alloc regions");
  HeapRegion* res = _g1h->new_gc_alloc_region(word_size, count(), InCSetState::Old);
  return res;
}
