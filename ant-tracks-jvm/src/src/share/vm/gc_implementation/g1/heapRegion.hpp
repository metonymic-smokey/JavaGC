...
class G1OffsetTableContigSpace: public CompactibleSpace {
 ...
 protected:
  virtual SpaceKind space_type() { return G1OFFSETTABLECONTIGSPACE; }
...
class HeapRegion: public G1OffsetTableContigSpace {
 ...
 public:
  ...
  void set_eden()        { _type.set_eden(); if(TraceObjects) EventsRuntime::fire_space_alloc(hrm_index(), SPACE_MODE_NORMAL, EDEN_SPACE); }
  void set_eden_pre_gc() { _type.set_eden_pre_gc(); }
  void set_survivor()    { _type.set_survivor(); if(TraceObjects) EventsRuntime::fire_space_alloc(hrm_index(), SPACE_MODE_NORMAL, SURVIVOR_SPACE); }
  void set_old() { _type.set_old(); if(TraceObjects) EventsRuntime::fire_space_alloc(hrm_index(), SPACE_MODE_NORMAL, OLD_SPACE); }
