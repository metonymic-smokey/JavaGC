...
class GCCause : public AllStatic {
 public:
  enum Cause {
    ...
    _g1_inc_collection_pause_young, // Only used by AntTracks to distinguish young-only and mixed G1 GCs
    _g1_inc_collection_pause_mixed, // Only used by AntTracks to distinguish young-only and mixed G1 GCs
