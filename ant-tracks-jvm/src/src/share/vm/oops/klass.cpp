...
Klass::Klass() {
  ...
  if(TraceObjectsAllocations){
        set_allocated_type_identifier(ALLOCATED_TYPE_IDENTIFIER_UNKNOWN);
  }
}

void Klass::set_allocated_type_identifier(AllocatedTypeIdentifier allocated_type_identifier) { 
    _allocated_type_identifier = allocated_type_identifier; 
}
AllocatedTypeIdentifier Klass::get_allocated_type_identifier() { 
    return _allocated_type_identifier; 
}
