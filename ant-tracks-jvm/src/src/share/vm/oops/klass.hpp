...
#include "prims/AllocatedTypes.hpp"
#if INCLUDE_ALL_GCS
...
class Klass : public Metadata {
 ...
 protected:
  ...
  AllocatedTypeIdentifier _allocated_type_identifier;
private:
...
protected:
 ...
 public:
  ...
  void set_allocated_type_identifier(AllocatedTypeIdentifier allocated_type_identifier);
  AllocatedTypeIdentifier get_allocated_type_identifier();
 ...
 public:
  ...
  static ByteSize allocated_type_identifier_offset() { return in_ByteSize(offset_of(Klass, _allocated_type_identifier)); }
