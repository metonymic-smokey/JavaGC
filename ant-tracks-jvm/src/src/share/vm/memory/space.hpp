...
class Space: public CHeapObj<mtGC> {
 ...
 protected:
  virtual SpaceKind space_type() {return SPACE; };
  HeapWord* _bottom;
  HeapWord* _end;
...
private:
  ...
  virtual SpaceKind space_type() { return CONTIGUOUSSPACE; }
...
class EdenSpace : public ContiguousSpace {
 ...
 private:
  ...
  virtual SpaceKind space_type() { return EDENSPACE; }
 public:
...
private: 
    virtual SpaceKind space_type() { return CONCEDENSPACE; }
 public:
...
class TenuredSpace: public OffsetTableContigSpace {
  friend class VMStructs;
private:
    virtual SpaceKind space_type() { return TENUREDSPACE; }
 protected:
  // Mark sweep support
