...
# endif
  ...
  static void new_instance_C(Klass* instance_klass, AllocationSiteIdentifier allocation_site, JavaThread *thread);

  // Allocate storage for a objArray or typeArray
  static void new_array_C(Klass* array_klass, AllocationSiteIdentifier allocation_site, int len, JavaThread *thread);
  static void new_array_nozero_C(Klass* array_klass, AllocationSiteIdentifier allocation_site, int len, JavaThread *thread);
  ...
  static void multianewarray2_C(Klass* klass, AllocationSiteIdentifier allocation_site, int len1, int len2, JavaThread *thread);
  static void multianewarray3_C(Klass* klass, AllocationSiteIdentifier allocation_site, int len1, int len2, int len3, JavaThread *thread);
  static void multianewarray4_C(Klass* klass, AllocationSiteIdentifier allocation_site, int len1, int len2, int len3, int len4, JavaThread *thread);
  static void multianewarray5_C(Klass* klass, AllocationSiteIdentifier allocation_site, int len1, int len2, int len3, int len4, int len5, JavaThread *thread);
  static void multianewarrayN_C(Klass* klass, arrayOopDesc* dims, AllocationSiteIdentifier allocation_site, JavaThread *thread);
