...
private:
  ...
  void fire_obj_alloc_event(AllocateNode* allocation, AllocationSiteIdentifier allocation_site, bool is_allocation_with_deviant_type, Node** ctrl, Node** mem, Node** obj, Node* length);
  void store_allocation_site(AllocateNode* allocation, AllocationSiteIdentifier allocation_site, Node** ctrl, Node** mem, Node** obj);
  Node* generate_next_hash(Node** ctrl, Node** mem, Node* obj, bool allow_zero_hash);
  Node* increment_L_1(Node* ctrl, Node* mem, Node* base, int offset) { return increment_L_C(ctrl, mem, base, offset, 1); }
  Node* increment_L_C(Node* ctrl, Node* mem, Node* base, int offset, jlong modifier) { return increment_L_N(ctrl, mem, base, offset, longcon(modifier)); }
  Node* increment_L_N(Node* ctrl, Node* mem, Node* base, int offset, Node* modifier);
  void atomic_increment_L(Node** ctrl, Node** mem, Node* base, int offset, Node* modifier);
  Node* breakpoint(Node* ctrl, Node* mem, Node* return_addr, Node* frame_ptr);
#ifdef ASSERT
  Node* assert_I(Node* ctrl, Node* mem, Node* return_addr, Node* frame_ptr, Node* left, BoolTest::mask test, Node* right, const char* message);
  Node* assert_X(Node* ctrl, Node* mem, Node* return_addr, Node* frame_ptr, Node* left, BoolTest::mask test, Node* right, const char* message);
  Node* assert__(Node* ctrl, Node* mem, Node* return_addr, Node* frame_ptr, CmpNode* comparison, BoolTest::mask test, const char* message);
#endif
