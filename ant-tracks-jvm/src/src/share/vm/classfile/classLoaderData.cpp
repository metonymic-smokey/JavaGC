...
ClassLoaderData::~ClassLoaderData() {
  if(TraceObjectsAllocations && ReuseUnloadedAllocationSites){
    //Save allocation sites as string (for allocation site id reuse)      
    AllocationSites::save_unloaded_allocation_sites(_klasses);
  }
