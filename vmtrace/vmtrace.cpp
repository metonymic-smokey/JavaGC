...
public:
  MethodName(jvmtiEnv *jvmti, jmethodID method)
      : _jvmti(jvmti), _holder_name(NULL), _method_name(NULL) {
    jclass holder;
...
void JNICALL ClassPrepare(jvmtiEnv *jvmti, JNIEnv *env, jthread thread,
                          jclass klass) {
...
JNIEXPORT jint JNICALL Agent_OnLoad(JavaVM *vm, char *options, void *reserved) {
  ...
  jvmti->SetEventNotificationMode(JVMTI_ENABLE, JVMTI_EVENT_VM_OBJECT_ALLOC,
                                  NULL);
  jvmti->SetEventNotificationMode(JVMTI_ENABLE,
